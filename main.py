...
class Gsmarena():
    ...
    def __init__(self):
        ...
        self.absolute_path = os.path.join(os.getcwd(), self.new_folder_name)  # Absolute path of the GSMArenaDataset folder (cross-platform).
    ...
    def crawl_html_page(self, sub_url):
        ...
        time.sleep(3)  # Small delay to reduce request rate
    ...
    def create_folder(self):
        ...
        print("Ensured", self.new_folder_name, "folder at:", self.absolute_path)
        ...
        for brand in phone_brand:
            ...
            if (brand[0].title() + '.csv') not in files_list:
                ...
                for value in link:
                    ...
                    model_value+=1
                csv_path = os.path.join(self.absolute_path, f"{brand[0].title()}.csv")
                with open(csv_path, "w", newline='', encoding='utf-8') as file:
                    dict_writer = csv.DictWriter(file, fieldnames=self.features, extrasaction='ignore')
